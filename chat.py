...
def build_parser() -> argparse.ArgumentParser:
    ...
    s.add_argument("--topic", help="channel topic or description")
    ...
    s.add_argument("--body", help="message body as string")
    ...
    s.add_argument("channel", help="name of the channel")
    s.add_argument("--as", dest="agent", required=True, help="agent name waiting for messages")
    s.add_argument("--timeout", type=float, default=900.0, help="maximum time to wait in seconds (default: 900.0)")
    s.add_argument("--interval", type=float, default=5.0, help="polling interval in seconds (default: 5.0)")
