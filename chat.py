...
def build_parser() -> argparse.ArgumentParser:
    ...
    s.add_argument("channel", help="channel for the locks")
    s.add_argument("paths", nargs="+", help="paths to lock")
    s.add_argument("--as", "--from", "--owner", dest="owner", required=True, help="agent locking the paths")
    s.add_argument("--lease-seconds", "--lease", "--ttl", type=float, default=300.0, help="duration of the lock in seconds")
    ...
    s.add_argument("--as", "--from", "--owner", dest="owner", required=True, help="agent unlocking the path")
    ...
    s.add_argument("--lease-seconds", "--lease", "--ttl", type=float, default=300.0, help="duration of the new lock in seconds")
