...
def _seq_from_name(name: str) -> int | None:
    # Optimization: Use str.split and isdecimal instead of re.match for extracting sequence numbers.
    # It is significantly faster in tight loops scanning large directories, and isdecimal prevents Unicode conversion errors.
    parts = name.split('-', 1)
