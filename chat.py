...
def build_parser() -> argparse.ArgumentParser:
    ...
    s.add_argument("--topic", help="topic of the channel")
    ...
    s.add_argument("channel", help="name of the channel")
    s.add_argument("--from", dest="sender", required=True, help="name of the sending agent")
    s.add_argument("--to", help="recipient agent, or 'all' (default all)")
    s.add_argument("--title", required=True, help="title of the message")
    s.add_argument("--reply", type=int, help="seq this replies to")
    s.add_argument("--status", default="discussion", help="status of the message")
    ...
    s.add_argument("channel", help="name of the channel")
    s.add_argument("--as", dest="agent", required=True, help="agent name reading the messages")
    s.add_argument(
    ...
    s.add_argument("channel", help="name of the channel")
    s.add_argument("--as", dest="agent", required=True, help="agent name waiting for reply")
    s.add_argument("--timeout", type=float, default=900.0, help="max seconds to wait (default: 900.0)")
    ...
    s.add_argument("--as", dest="agent", required=True, help="agent name claiming the task")
