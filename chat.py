...
def build_parser() -> argparse.ArgumentParser:
    ...
    s.add_argument("channel", help="channel name")
    s.add_argument("--from", dest="sender", required=True, help="name of the sender")
    ...
    s.add_argument("channel", help="channel name")
    s.add_argument("--as", dest="agent", required=True, help="agent name to read as")
    s.add_argument(
    ...
    s.add_argument("channel", help="channel name")
    s.add_argument("--as", dest="agent", required=True, help="agent name to wait as")
