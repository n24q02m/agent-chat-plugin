...
def build_parser() -> argparse.ArgumentParser:
    ...
    s.add_argument("--topic", help="channel topic")
    ...
    s.add_argument("channel", help="channel name")
    s.add_argument("--as", dest="agent", required=True, help="agent name waiting for a reply")
    s.add_argument("--timeout", type=float, default=900.0, help="max wait time in seconds")
    s.add_argument("--interval", type=float, default=5.0, help="poll interval in seconds")
