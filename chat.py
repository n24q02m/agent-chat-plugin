...
def build_parser() -> argparse.ArgumentParser:
    ...
    s.add_argument("--topic", help="initial topic for the channel")
    ...
    s.add_argument("channel", help="name of the channel")
    s.set_defaults(func=cmd_roster)

    s = sub.add_parser(
        "post", help="post a message (body via --body/--body-file/stdin)"
    )
    s.add_argument("channel", help="name of the channel to post in")
    s.add_argument("--from", dest="sender", required=True, help="name of the sender agent")
    ...
    s.add_argument("--as", dest="agent", required=True, help="name of the agent reading")
    s.add_argument(
    ...
    s.add_argument("--as", dest="agent", required=True, help="name of the agent waiting")
    s.add_argument("--timeout", type=float, default=900.0, help="max seconds to wait")
    s.add_argument("--interval", type=float, default=5.0, help="seconds between polls")
    ...
    s.add_argument("--as", dest="agent", required=True, help="name of the claiming agent")
