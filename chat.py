...
def build_parser() -> argparse.ArgumentParser:
    ...
    sub = p.add_subparsers(dest="cmd", required=True, help="available sub-commands")
    ...
    event_sub = event.add_subparsers(dest="event_cmd", required=True, help="available event commands")
