...
def parse_frontmatter(path: Path) -> dict:
    ...
    meta: dict = {}
    try:
        # Bolt performance optimization: Only read file line-by-line until the
        # closing '---' instead of reading the entire file text into memory at
        # once. This avoids large allocations for large markdown message bodies.
