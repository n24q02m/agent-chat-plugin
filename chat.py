...
def build_parser() -> argparse.ArgumentParser:
    ...
    s.add_argument("channel", help="name of the channel")
    s.add_argument("--from", dest="sender", required=True, help="sender's agent name")
    ...
    s.add_argument("--status", default="discussion", help="status of the message (default: discussion)")
    s.add_argument("--body", help="message body text")
    s.add_argument("--body-file", help="path to a file containing the message body")
    s.set_defaults(func=cmd_post)

    s = sub.add_parser("read", help="print new messages for an agent (advances cursor)")
    s.add_argument("channel", help="name of the channel")
    s.add_argument("--as", dest="agent", required=True, help="agent name reading messages")
    s.add_argument(
