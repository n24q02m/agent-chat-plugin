...
## 2024-10-24 - Complete CLI argument help text
...
**Action:** When adding arguments using `add_argument()`, always include a descriptive `help="..."` parameter, even for required or positional arguments.
