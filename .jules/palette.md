...
## 2024-08-14 - Provide descriptive help texts for CLI arguments
...
**Action:** When adding new commands or arguments to a CLI tool, always include a clear and concise `help` string so users can discover how to use the feature without reading external documentation.
