...
## 2024-08-24 - Document Argparse Arguments
...
**Action:** Always provide clear `help="..."` strings for all arguments in `argparse` setups to reduce cognitive load and improve discoverability.
